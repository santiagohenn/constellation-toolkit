...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        // Load from file
        List<double[]> ROI = FileUtils.file2DoubleList("C:/Projects/lora-simulator/inputs/rois/caribbean.csv");
        ...
        List<Satellite> satelliteList = Utils.satellitesFromFile("C:\\Projects\\lora-simulator\\inputs\\constellation_caribbean.csv");
